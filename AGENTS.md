...
`pnpm run package:plugin` builds and validates `dist/kagayoi-memory`. CI runs these checks and uploads the package as an artifact; release tagging and publication remain separate operations.
